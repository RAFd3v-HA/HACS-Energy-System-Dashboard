const ENERGY_SYSTEM_DASHBOARD_VERSION = "0.7.8";
...
if (!customElements.get("energy-system-dashboard-panel-v078")) {
  customElements.define("energy-system-dashboard-panel-v078", EnergySystemDashboardPanel);
}
