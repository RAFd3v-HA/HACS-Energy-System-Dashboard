const ENERGY_SYSTEM_DASHBOARD_VERSION = "0.7.5";
    ...
    return `
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .flow-rail-cell::before { content:""; position:absolute; width:2px; left:50%; transform:translateX(-50%); background:var(--rail-base); }
        ...
        .flow-rail-cell.active::after { content:""; position:absolute; left:50%; transform:translateX(-50%); width:2px; top:0; bottom:0; background:var(--rail-live); }
        ...
        .flow-branch { position:absolute; top:21px; height:2px; background:var(--rail-base); }
...
if (!customElements.get("energy-system-dashboard-panel-v075")) {
  customElements.define("energy-system-dashboard-panel-v075", EnergySystemDashboardPanel);
}
